 ...
 */
 // [PC] - use P2_04 (E1 heater for controlling fan)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_ALERT_BEEPS         45  // Number of alert beeps to play when a response is needed.
...
// [PC] ................. Motor Drivers
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       810       // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       1000  // [PC] Replace with 1.68A dual axis motor
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      710 // [PC] - Changed for Direct Drive Motor from Mellow (1A max)
    #define E0_MICROSTEPS    16
