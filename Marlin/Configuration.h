 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 100, 10000 }// [PC] Ender5 Example Setting =>{ 500, 500, 100, 5000 }
...
// [PC] For Ender 5, u
#define NOZZLE_TO_PROBE_OFFSET { -27, -9, -4.0 }
...
#define INVERT_Y_DIR false // [PC] TMC5160 Seems to invert directions
#define INVERT_Z_DIR false // [PC] TMC5160 Seems to invert directions
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  #define MIN_SOFTWARE_ENDSTOP_Z //[PC] Not using Z min soft stop.  When enabled, use M211 S0 to disable and M211 S1 to enable
#endif
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  // [PC] - Set FIL_RUNOUT_PIN to Z+ on SKR1.3 (pin 1.24)
  #define FIL_RUNOUT_PIN       P1_24

  #define NUM_RUNOUT_SENSORS   1     // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
  #define FIL_RUNOUT_INVERTING false // Set to true to invert the logic of the sensor. [PC] set to true to invert.  Ender 5 Plus OEM sensor would set to low if filament is present
...
// [PC] - Use this home pos to offset nozzle if home is outside of bed area.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS - 3), (Y_MIN_POS - 1), 20 }
